...
public class DonutController {
    ...
    public String home(Model model) {
        ...
        List<DonutPackage> packages = List.of(
                new DonutPackage("4 unidades", "R$ 6,00", "/images/4-donuts.jpg", 4),
                new DonutPackage("8 unidades", "R$ 8,00", "/images/8-donuts.jpg", 8),
                new DonutPackage("16 unidades", "R$ 12,00", "/images/16-donuts.jpg", 16),
                new DonutPackage("20 unidades", "R$ 22,00", "/images/20-donuts.jpg", 20)
        );
